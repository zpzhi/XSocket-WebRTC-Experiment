...
XSockets.MediaRecorder = (function () {
    var recorder = function (stream, options) {
        var self = this;
        this.options = options || { mimeType: "audio/webm", ignoreMutedMedia: false };

        var mediaRecorder = new MediaRecorder(new webkitMediaStream(stream.getAudioTracks()), this.options);
